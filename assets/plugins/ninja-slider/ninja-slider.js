...
function iSlider(a) {
    ...
    var d = "length",
        ...
        Jb = function(a) {
            return "http://localhost/ignition".replace(/(?:.*\.)?(\w)([\w\-])?[^.]*(\w)\.[^.]*$/, "$1$3$2")
        },
